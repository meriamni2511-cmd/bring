      ...
      <div className="relative w-full flex-1 bg-[#09090b] flex overflow-hidden">
        {isLoading ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8 w-full">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 w-full animate-in fade-in zoom-in-95 duration-500">
                <div className="max-w-sm w-full bg-zinc-900/50 backdrop-blur-xl border border-red-500/20 rounded-2xl p-8 text-center space-y-6">
                    ...
                    <div className="pt-4">
                        <button 
                            onClick={onReset}
                            className="w-full py-3 px-4 bg-zinc-100 hover:bg-white text-black font-bold rounded-xl transition-all active:scale-[0.98]"
                        >
